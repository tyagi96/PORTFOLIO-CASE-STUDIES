...
So, now that you have understood the month-wise trend of movies, letâ€™s take a look at the other details in the
'movies' table. 
...
Now, let's find out the ideal duration for RSVP Moviesâ€™ next project.*/
...
-- Q15. Find the movies in each genre that start with the characters â€˜Theâ€™ and have an average rating > 8.
...
-- You should also try out the same for median rating and check whether the â€˜median ratingâ€™ column gives any
...
table. 
Letâ€™s begin by searching for null values in the table. */
...
/* The director is the most important person in a movie crew. 
   Letâ€™s find out the top three directors each in the top three genres who can be hired by RSVP Movies. */
...
/* Finally, letâ€™s find out the names of the top two production houses that have produced the highest number of hits
